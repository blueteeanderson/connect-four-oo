class Game {
  constructor(height, width, players) {
    ...
    this.gameIsOver = false; //is the game over
    this.makeBoard();
    this.makeHtmlBoard();
    this.players = players;
    this.currPlayer = this.players[0]; // active player: by color
  }
  ...
  handleClick(evt) {
    if (!this.gameIsOver) {
      ...
      // switch players
      this.currPlayer =
        this.currPlayer.color === this.players[0].color
          ? this.players[1]
          : this.players[0];
    }
  }
